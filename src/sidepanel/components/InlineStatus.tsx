...
const toneClasses: Record<InlineStatusProps['tone'], string> = {
  neutral: 'border-index-line bg-index-surface-muted text-index-muted',
  progress: 'border-index-accent/35 bg-index-accent-soft text-index-ink',
...
export function InlineStatus({
  ...
  return (
    <div className={`flex items-start gap-2 rounded-index border px-3 py-2.5 text-sm leading-body shadow-sm ${toneClasses[tone]}`}>
